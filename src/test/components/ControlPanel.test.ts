...
const makeStore = (raceStatus: RaceStatus = RACE_STATUS.IDLE) => {
...
const mountPanel = (raceStatus: RaceStatus = RACE_STATUS.IDLE) => {
...
describe("ControlPanel", () => {
  ...
  it("displays the current status text", () => {
    ...
    expect(wrapper.get('[data-testid="status-badge"]').text()).toContain(RACE_STATUS.SCHEDULED)
  })
